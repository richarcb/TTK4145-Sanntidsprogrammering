...
// STATE MACHINE //
func Fsm(start_floor int, cancel_illuminate_extern_order_ch <-chan int, illuminate_extern_order_ch <-chan elevio.ButtonEvent, door_timer_ch <-chan bool, extern_order_ch <-chan elevio.ButtonEvent, buttons_ch <-chan elevio.ButtonEvent, floors_ch <-chan int /*receiveing channels*/, reached_extern_floor_ch chan<- elevio.ButtonEvent, new_order_ch chan<- elevio.ButtonEvent, state_ch chan<- Elevator, reset_timer_ch chan<- bool) {
