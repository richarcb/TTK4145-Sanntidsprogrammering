...
// STATE MACHINE //
func EventHandler(clear_lights_and_extern_orders_ch <-chan int, start_floor int, cancel_illuminate_extern_order_ch <-chan int, illuminate_extern_order_ch <-chan elevio.ButtonEvent, extern_order_ch <-chan elevio.ButtonEvent, buttons_ch <-chan elevio.ButtonEvent, floors_ch <-chan int /*receiveing channels*/, reached_extern_floor_ch chan<- elevio.ButtonEvent, new_order_ch chan<- elevio.ButtonEvent, state_ch chan<- Elevator) {
